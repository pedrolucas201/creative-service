...
type Handlers interface {
	...
	InternalContingencyTick(http.ResponseWriter, *http.Request)
	InternalContingencyExecute(http.ResponseWriter, *http.Request)
	MonitorContingency(http.ResponseWriter, *http.Request)
	GetContingencyConfig(http.ResponseWriter, *http.Request)
	UpsertContingencyNode(http.ResponseWriter, *http.Request)
	UpsertContingencyRoute(http.ResponseWriter, *http.Request)
	DeleteContingencyRoute(http.ResponseWriter, *http.Request)
	ListContingencyIncidents(http.ResponseWriter, *http.Request)
	GetContingencyIncident(http.ResponseWriter, *http.Request)
	ExecuteContingency(http.ResponseWriter, *http.Request)
	RetryContingencyIncident(http.ResponseWriter, *http.Request)
	CloseContingencyIncident(http.ResponseWriter, *http.Request)
	ListContingencyExecutions(http.ResponseWriter, *http.Request)
	...
	GetAdAccountMetaStatus(http.ResponseWriter, *http.Request)
...
func NewRouter(h Handlers, opts RouterOptions) http.Handler {
	...
	r.Post("/v1/internal/contingency/tick", h.InternalContingencyTick)
	r.Post("/v1/internal/contingency/execute", h.InternalContingencyExecute)
	...
	protected.Post("/v1/contingency/monitor", h.MonitorContingency)
	protected.Get("/v1/contingency/config", h.GetContingencyConfig)
	protected.Post("/v1/contingency/nodes", h.UpsertContingencyNode)
	protected.Post("/v1/contingency/routes", h.UpsertContingencyRoute)
	protected.Delete("/v1/contingency/routes/{route_uuid}", h.DeleteContingencyRoute)
	protected.Get("/v1/contingency/incidents", h.ListContingencyIncidents)
	protected.Get("/v1/contingency/incidents/{incident_uuid}", h.GetContingencyIncident)
	protected.Post("/v1/contingency/execute", h.ExecuteContingency)
	protected.Post("/v1/contingency/incidents/{incident_uuid}/retry", h.RetryContingencyIncident)
	protected.Post("/v1/contingency/incidents/{incident_uuid}/close", h.CloseContingencyIncident)
	protected.Get("/v1/contingency/executions", h.ListContingencyExecutions)
	protected.Get("/v1/clients", h.ListClients)
	protected.Get("/v1/clients/{client_uuid}/ad-accounts", h.ListAdAccountsByClient)
	protected.Get("/v1/ad-accounts/{ad_account_id}/meta-status", h.GetAdAccountMetaStatus)
